...
export default async function HomePage({ params }: PageProps) {
  ...
  return (
    <div className="flex flex-col w-full bg-ocean-black">
      ...
      <section className="relative min-h-[90vh] lg:min-h-screen w-full grid grid-cols-1 lg:grid-cols-12 overflow-hidden bg-ocean-black pt-24 lg:pt-0">
        
        {/* Left text column & quick access links */}
        <div className="col-span-12 lg:col-span-7 xl:col-span-6 flex flex-col justify-center px-4 sm:px-8 md:px-12 lg:px-16 py-16 xl:py-24 relative z-10 bg-gradient-to-r from-ocean-black via-ocean-black/95 to-ocean-black/80">
        ...
        {/* Right logistics image column */}
        <div className="col-span-12 lg:col-span-5 xl:col-span-6 relative h-[350px] lg:h-full min-h-[350px] overflow-hidden bg-ocean-black group">
          <Image
